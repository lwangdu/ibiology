 ...
 * @category	Class
 * @author 		Tech Liminal
 * @description The Post Type that represents a Speaker in a lecture.
 *
 */
		...
		register_post_type( self::$post_type,
			array(
				'labels'               => array(
					...
					'add_new'             => __( 'New Speaker', 'ibiology' ),
					'edit_item'           => __( 'Edit Speaker', 'ibiology' ),
					'update_item'         => __( 'Update Speaker', 'ibiology' ),
					'search_items'        => __( 'Search Speakers', 'ibiology' ),
					'not_found'           => __( 'No Speakers found', 'ibiology' ),
					'not_found_in_trash'  => __( 'No Speakers found in Trash', 'ibiology' ),
						),
				'label'               => __( 'Speakers', 'ibiology' ),
				'description'         => __( 'IBiology Speaker with one or more Videos', 'ibiology' ),
				'supports'						=> $supports,
...
/* --------------------  TAXONOMIES ---------------------- */
	...
	function default_title($title){
		if ( isset( $_REQUEST['post_type']) && self::$post_type == $_REQUEST['post_type'] ) {
			return "Long title of This Speaker"; 
		} else {
			return $title;
		}
		return $title;
