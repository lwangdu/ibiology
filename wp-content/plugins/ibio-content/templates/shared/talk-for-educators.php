...
<table class="expanded-talks">
    ...
    <tr class="resources"><td colspan="6" class="restricted-access"><strong>Educator Resources for this talk: </strong><?php echo $resources;?></td><td class="restricted-access"></td></tr>
